...
const sortedMergeRecursion = function(list1, list2) {
  if (!list1) {
    return list2
  }
  ...
  if (list1.val < list2.val) {
    list1.next = sortedMergeRecursion(list1.next, list2)
    return list1
  }

  else {
    list2.next = sortedMergeRecursion(list1, list2.next)
    return list2
  }
};
...
const sortedMergeIterative = function(list1, list2) {
...
/**
 Approach 3: Iteration with new list
 */
import {LinkedList} from "../data_structures/LinkedList.js";

export const sortedMergeIntoNewList = function(list1, list2) {
  if (!list1) {
    return list2
  }
...
// const list1 = new LinkedList().fromArray([1,3,5])
// const list2 = new LinkedList().fromArray([2,4])
// const l1 = list1.head
// const l2 = list2.head
// const result = sortedMergeIntoNewList(l1, l2)
